    ...
    <main className='min-lg:w3/4'>
      ...
      <Accordion type='multiple' >
        ...
        <AccordionItem value="recent">
          <AccordionTrigger className='text-lg font-bold'>Recent Sessions</AccordionTrigger>
        ...
        {/* <AccordionItem value="companions">
          <AccordionTrigger className='text-lg font-bold'>My Companions</AccordionTrigger>
          <AccordionContent className=''>
